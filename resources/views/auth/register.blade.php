...
<div class="wrap-input100 validate-input" data-validate = "Nom">
    <input class="input100" type="text" name="name" placeholder="Nom" value="{{ old('name') }}"  required autocomplete="name" autofocus>
...
@enderror
             ...
             <div class="wrap-input100 validate-input" data-validate = "Adresse mail">
					...
					<div class="wrap-input100 validate-input" data-validate="Mot de passe">
						<input class="input100" type="password" name="password_confirmation" placeholder="Mot de passe" required autocomplete="new-password">
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					...
					<a style="text-decoration:none ;color:white"  href="{{ route('login') }}">Connexion</a>
					</div>
